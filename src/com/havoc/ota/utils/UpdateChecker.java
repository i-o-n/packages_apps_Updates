...
import com.havoc.ota.UpdaterApplication;
import com.havoc.ota.activities.UpdaterActivity;
import com.havoc.ota.misc.Constants;
import com.havoc.ota.misc.State;
import com.havoc.ota.misc.UpdateInfo;
import com.havoc.ota.requests.UpdatesJsonObjectRequest;
import com.havoc.ota.service.UpdateCheckService;
...
public class UpdateChecker implements Response.ErrorListener, Response.Listener<JSONObject> {
    ...
    // broadcast actions
    public static final String ACTION_CHECK_FINISHED = "com.havoc.ota.action.UPDATE_CHECK_FINISHED";
