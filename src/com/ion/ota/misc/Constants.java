...
public final class Constants {
    ...
    static final String PROP_DEVICE = "ro.ion.device";
    static final String PROP_BUILD_VERSION = "ro.ionizer";
    static final String PROP_VERSION_CODE = "ro.ion.ota.version_code";
    static final String OTA_URL = "https://raw.githubusercontent.com/ion-OS/OTA/ten/%s.json";
    static final String DOWNLOAD_WEBPAGE_URL = "https://raw.githubusercontent.com/ion-OS/OTA/ten/%s.md";
    public static final String DOWNLOAD_PATH = "/data/system_updates/";
    static final String EXPORT_PATH = "ion-Updates/";
}
