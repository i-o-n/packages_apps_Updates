...
import com.ion.ota.requests.UpdatesJsonObjectRequest;
import com.ion.ota.service.UpdateCheckService;
...
public class UpdateChecker implements Response.ErrorListener, Response.Listener<JSONObject> {
    ...
    // broadcast actions
    public static final String ACTION_CHECK_FINISHED = "com.ion.ota.action.UPDATE_CHECK_FINISHED";
